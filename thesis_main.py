...
#for 1st 5
dr1=r'E:\DATA\data\data1'
Fits_file1= glob.glob(os.path.join(dr1, '*.fits'))
#for 6-10
dr2=r'E:\DATA\data\data2'
Fits_file2 = glob.glob(os.path.join(dr2, '*.fits'))
#for 11-15
dr3=r'E:\DATA\data\data3'
Fits_file3 = glob.glob(os.path.join(dr3, '*.fits'))
#for 16-20
dr4=r'E:\DATA\data\data3'
Fits_file4 = glob.glob(os.path.join(dr4, '*.fits'))
#for 21-25
dr5=r'E:\DATA\data\data3'
Fits_file5 = glob.glob(os.path.join(dr5, '*.fits'))
#for 26-30
dr6=r'E:\DATA\data\data3'
Fits_file6 = glob.glob(os.path.join(dr6, '*.fits'))
#for 31-35
dr7=r'E:\DATA\data\data3'
Fits_file7 = glob.glob(os.path.join(dr7, '*.fits'))
#for 36-40
dr8=r'E:\DATA\data\data3'
Fits_file8 = glob.glob(os.path.join(dr8, '*.fits'))
#for 41-45
dr9=r'E:\DATA\data\data3'
Fits_file9 = glob.glob(os.path.join(dr9, '*.fits'))
#for 46-50
dr10=r'E:\DATA\data\data3'
Fits_file10 = glob.glob(os.path.join(dr10, '*.fits'))
